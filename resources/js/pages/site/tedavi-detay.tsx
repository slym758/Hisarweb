...
/* ───────────────────────── PAGE ───────────────────────── */
export default function TedaviDetay() {
    ...
    const relatedDoctors = getDoctorsForDept(treatment.deptSlug, locale).slice(0, 3);
                            ...
                            <div className="rounded-2xl border border-border bg-card p-5">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <p className="text-[13px] font-bold text-primary">{dept.name}</p>
                                    </div>
